		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li :class="{'on':index==0}" key="index" v-for="(img,index) in itemsInfo.ali_images" v-bind:key="index"><img :src="img+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'"></li>
						</ul>
					</div>
					<div class="thumb">
						<ul>
							<li :class="{'on':index==0}" key="index" v-for="(img,index) in itemsInfo.ali_images" v-bind:key="index"><img :src="img+'?x-oss-process=image/resize,w_440/quality,Q_90/format,webp'"></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="sku-dynamic-params-panel">
					<div class="sku-dynamic-params clear">
						...
						<ul class="params-colors">
							<li :class="{'cur':color.id==$route.query.itemId}" v-for="(color,index) in itemsInfo.sku_list" v-bind:key="index">
